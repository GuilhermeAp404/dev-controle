...
const schema = z.object({
    email: z.string().email("Digite o email do cliente para localizar.").min(1, "Campo E-mail é obrigatorio")
})
            ...
            <main className="flex flex-col mt-4 mb-2">
                {customer ?(
                    <div className="bg-slate-200 py-6 px-4 rounded border-2 flex items-center justify-between">
                        ...
                        <button className="bg-red-600 h-11 px-2 items-center justify-center rounded" onClick={handleClearCustumer}>
                    ...
                    >
                        <div className="flex flex-col gap-3">
                            ...
                            <button 
                                type="submit"
                                className="bg-blue-500 flex flex-row gap-3 px-2 h-11 justify-center items-center text-white font-bold rounded"
                            >
                                procurar cliente
